...
function enhance(modal,cotId){
 ...
 if(oldGrid){const spans=[...oldGrid.children];const subtotalSpan=document.createElement('span');subtotalSpan.textContent='Subtotal';subtotalSpan.style.textAlign='right';if(spans.length>=5)oldGrid.insertBefore(subtotalSpan,spans[4]);}
